...
% Makes sense if the signal s is a full period along the vector t.
%--------------------------------------------------------------------------
...
% %
% % *** Open Problem: phase is not calculated correctly
% % *** Open Problem: m=0 amplitude is too large by a factor of 2
% 
% T = 64;
% phi = ((1:T)'-1)/T;
% 
