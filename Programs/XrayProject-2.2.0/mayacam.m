...
%David Baier 4/30/07
%last updated 6/04/2010 LJR - removed rad2deg call
...
[xyfile,xypath]=uigetfile({'*.csv','comma separated values'}, ...
    'Please select your _xypoints.csv file from the DLT calibration',specpath);

% cd(xypath);

xydata = dlmread([xypath,xyfile],',',1,0);

[coefs, avgres] = mdlt1(specdata,xydata);
