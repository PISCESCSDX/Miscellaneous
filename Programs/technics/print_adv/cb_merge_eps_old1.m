...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% READ/WRITE jpg POSITION Data to eps-dat.mat
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tempeps = dir('temp_epsdat.mat');
ltemp   = length(tempeps);
...
% OLD WORKING VERSION:
% function [] = cb_merge_eps(epsfile, jpegepsname, endepsfile_name, axnum, epsname)
% %function [] = cb_merge_eps(epsfile, jpegepsname, endepsfile_name, axnum)
% % Merges the generated postscript output of axes*.eps and
% % matrix (as raster image) and save the resulting eps
% % as filename.
...
% % quiver-plots)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % PROCEDURE:  If "0 sg" appears more than 1 time after "1 sg", take only
% % the first one after each "1 sg"
% if length(lines_1sg)<length(lines_0sg)
%   % SEARCH for first "0 sg" after each "1 sg"
%   for r0 = 1:length(lines_1sg)
...
% else
%   if length(lines_1sg)>length(lines_0sg)  
%     %error('If this error appears, a new problem is present, never before.')
%   end
% end
% 
% 
