function htilde = mktilde(ht, str, itilde, topchar)
%==========================================================================
%function htilde = mktilde(ht, str, itilde, topchar)
%--------------------------------------------------------------------------
% INFO 2013-08-14 Does not work reliable. Positioning is weird ...
% Set a tilde over a character in a text string.
...
%   xlb = 'n [m^{-3}]';
%   mktilde(hx, xlb, 1)
% htilde = mktilde(hy, '\phi [m^{-3}]', 1)
%==========================================================================

if nargin < 4; topchar = '~'; end
