...
% vfname = '18662_f650_ap1.7_velo_triangle_d1_t0001-5000_winrat0.20.mat';

vfname = '18662_f650_ap1.7_velo_triangle_d1_t0001-5000_winrat1.00.mat';
...
% for ifvec = 2:length(pa1.freq); clf; fa = pa1.freq(ifvec); fb = fa;



fvec = [1000 4000 7000 10000 13000 16000 19000 22000 25000];

for i=1:length(fvec)-1

fa = fvec(i); fb = fvec(i+1); clf; j=0;
% fa = 10000; fb = 13000; 

startx_red = 0; starty_red = -3.5;
...
% fn = mkstring('18662_','0',round(fa),10000,'Hz.png');
% print('-dpng',fn); j=0;
% end
%-------------------------------------------------------------------- Print
