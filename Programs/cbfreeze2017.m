function CBH = cbfreeze2017(varargin)
...
for icb = 1:length(CBH)
 ...
 switch S
  ...
  otherwise % 'on'
   ...
   cb_prop.XLim = [0.04,0.12];
   cb_prop.YLim = [0.3533,0.80];
   XLim = cb_prop.XLim;
   YLim = cb_prop.YLim;
...
%    end
   ...
   set(h,...
    ...
    'ButtonDownFcn'         ,@cbfreeze2017,...  % mhh...
    'DeleteFcn'             ,@cbfreeze2017)     % again
   set(pax,'DeleteFcn'      ,@cbfreeze2017)     % and again!  
