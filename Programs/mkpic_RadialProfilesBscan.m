...
x0 = 0.13; xw = 0.82;
j=0;
j=j+1; ax{j} = [x0 0.53 xw 0.47];
j=j+1; ax{j} = [x0 0.04 xw 0.47];
load('camerastatistics.mat');
...
figx=12; figeps(figx,18,1); clf; epsx = num2str(round(7.5*figx)); j=0;
%--------------------------------------------------------- 3D neutrals plot
...
%--------------------------------------------------------------- Print Plot
fn = ['camera-profiles_18417-18437_vertical_x' epsx '.eps'];
