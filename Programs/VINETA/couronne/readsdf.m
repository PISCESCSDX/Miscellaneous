function [data, time, params] = readsdf(file)
%==========================================================================
%function [data, time, params] = readsdf(file)
%--------------------------------------------------------------------------
% Script to read sdf files recorded by the  transient recorder T112 for 
...
%"SDF-Files"
	...
	data_raw=fread(fid,-X_min+X_max+1,'int16');
	comment=fread(fid,comment_length,'char');
	
	%creating output variables
	data=(data_raw+Y_min)*Y_step;
