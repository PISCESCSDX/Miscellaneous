function wdenoise7(data,fastmode)
%==========================================================================
%function wdenoise7(data,fastmode)
% June 7 (2012), Christian Brandt, San Diego (UCSD, CER)
%--------------------------------------------------------------------------
% WDENOISE7 wavelet filtering of a series of images
...
%     - new version: renamed to wdenoise7.m
%     - adaptation to improcess7.m reading cine files
